...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "BLUEDEPTH" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "VID_OUT_DATA_WIDTH" -parent ${Page_0}


}

proc update_PARAM_VALUE.BLUEDEPTH { PARAM_VALUE.BLUEDEPTH } {
	# Procedure called to update BLUEDEPTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.BLUEDEPTH { PARAM_VALUE.BLUEDEPTH } {
	# Procedure called to validate BLUEDEPTH
	return true
}
...
proc update_MODELPARAM_VALUE.BLUEDEPTH { MODELPARAM_VALUE.BLUEDEPTH PARAM_VALUE.BLUEDEPTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.BLUEDEPTH}] ${MODELPARAM_VALUE.BLUEDEPTH}
}
